...
/* harmony default export */ const navbar_image = ({"src":"/_next/static/media/navbar-image.498c3491.webp","height":667,"width":516,"blurDataURL":"data:image/webp;base64,UklGRkoAAABXRUJQVlA4ID4AAAAQAgCdASoGAAgAAkA4JZACdEf/geiAB4oAAP27s7uw4b5bLoLDhpViId/j3rRIOVZVWv/b6r0D4C8R+j7gAA==","blurWidth":6,"blurHeight":8});
// EXTERNAL MODULE: ./static/images/logo-large-black.svg
var logo_large_black = __webpack_require__(8903);
...
function Navbar() {
    ...
    const handleNavbar = (e)=>{
        ...
        if (document.querySelector("section.navbar").classList.contains("show")) {
            // handle hide
            const timeline1 = external_gsap_default().timeline();
            timeline1.to("section.navbar div.element a", {
                y: "100%",
                ease: "power4.out",
                duration: 0.8,
                stagger: 0.1
            }, 0);
            timeline1.to("section.navbar p", {
                y: "100%",
                ease: "power4.out",
                duration: 0.4,
                stagger: 0.1
            }, 0);
            timeline1.to("section.navbar hr", {
                width: "0",
                ease: "power4.out",
                duration: 0.8,
                stagger: 0.1
            }, 0);
            timeline1.to("section.navbar img", {
                height: "0%",
                ease: "power4.out",
                duration: 0.8
            }, 0.4);
            timeline1.to("section.navbar", {
                y: "-100vh",
                ease: "power4.inOut",
                duration: 1,
                onComplete: ()=>{
            ...
            timeline1.to("section.navbar div.links a", {
                y: 0,
                duration: 0.8,
                ease: "power3.out",
                stagger: 0.1
            ...
            timeline1.to("section.navbar div.gray-divider", {
                height: "100vh",
                ease: "power4.out",
                duration: 0.8
            }, 0.6);
                ...
                children: [
                    /*#__PURE__*/ jsx_runtime_.jsx("div", {
                        ...
                        children: /*#__PURE__*/ jsx_runtime_.jsx((link_default()), {
                            href: "/",
                            onClick: ()=>(typeof timeline !== "undefined") ?? timeline.killAll(),
